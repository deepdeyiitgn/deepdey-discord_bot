...
class MediaManager(commands.Cog):
    ...
    @commands.hybrid_command(name='listfiles', help='List available files in media folder')
    ...
    # hybrid 'listfiles' handles both prefix and slash usage; removed duplicate slash handler
